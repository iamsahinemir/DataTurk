...
We identified the columns that contained more than 50 percent of the missing data values in them and filled in these
 numeric columns using the calculated mean of such columns.
For non-numeric columns we used the mode. In order to eliminate the bugs in the code, we took advantage of some sources and ChatGPT-4.
