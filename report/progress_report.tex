...
We have created a python script, which can be found on our repo\cite{datatürk}, to identify the missing values in our given dataset, and
...
For non-numeric columns we used the mode. In order to eliminate the bugs in the code, we took advantage of some
 sources \cite{gunes} \cite{akademi} and ChatGPT-4.
