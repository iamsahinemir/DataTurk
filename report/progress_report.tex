...
The IEEEtran class file is used to \enquote{format} your paper and style the text. All margins, 
...
For papers published in translation \cite{güllüpınar} journals, please give the English 
citation first, followed by the original foreign-language \cite{pınar} citation \cite{b6}.
